        ...
        try
        {
            ...
            while (reader.Read())
            {
                configs.Add(new GDSignalConfig
                {
                    ...
                    NightSessionStartTime = reader.IsDBNull(8) ? "21:00" : reader.GetString(8),
                    NightSessionEndTime = reader.IsDBNull(9) ? "02:30" : reader.GetString(9),
                    MonitorIntervalMinutes = reader.IsDBNull(10) ? 30 : reader.GetInt32(10),
                    UseFixedTimePoints = reader.IsDBNull(11) ? true : reader.GetInt32(11) == 1,
                    FixedTimeMinutes = reader.IsDBNull(12) ? "0,15,30,45" : reader.GetString(12),
                    TerminalId = reader.IsDBNull(13) ? "" : reader.GetString(13),
                    EnableText = reader.IsDBNull(14) ? true : reader.GetInt32(14) == 1,
                    EnableImage = reader.IsDBNull(15) ? false : reader.GetInt32(15) == 1,
                    IsEnabled = reader.IsDBNull(16) ? false : reader.GetInt32(16) == 1,
                    Conditions = reader.IsDBNull(17) ? "[]" : reader.GetString(17),
                    EnableGD15 = reader.IsDBNull(18) ? false : reader.GetInt32(18) == 1,
                    EnableGD20 = reader.IsDBNull(19) ? false : reader.GetInt32(19) == 1,
                    EnableGD25 = reader.IsDBNull(20) ? false : reader.GetInt32(20) == 1,
                    EnableGD30 = reader.IsDBNull(21) ? false : reader.GetInt32(21) == 1,
                    EnableGD35 = reader.IsDBNull(22) ? false : reader.GetInt32(22) == 1,
                    EnableGD40 = reader.IsDBNull(23) ? false : reader.GetInt32(23) == 1,
                    EnableRealTimeStopPriceDiffRateCondition = reader.IsDBNull(24) ? true : reader.GetInt32(24) == 1,
                    EnableRemainingRiskCondition = reader.IsDBNull(25) ? false : reader.GetInt32(25) == 1,
                    RealTimeStopPriceDiffRateValue = reader.IsDBNull(26) ? 0 : reader.GetDouble(26),
                    RemainingRiskValue = reader.IsDBNull(27) ? 0 : reader.GetDouble(27),
